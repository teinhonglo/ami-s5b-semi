...
if [ $stage -le 0 ]; then  
  ...
  $rover ${ctms[@]} -o $dir/ascore_rover/rover.ctm -m maxconf 
  tr '[:lower:]' '[:upper:]' <  $dir/ascore_rover/rover.ctm > $dir/ascore_rover/rover.ctm.tmp
  mv $dir/ascore_rover/rover.ctm.tmp $dir/ascore_rover/rover.ctm
fi
